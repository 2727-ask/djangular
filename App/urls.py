...
from .Views import categoryAPIView, blogpostAPIView, signUpAPIView,profileAPIView
urlpatterns = [
    path('api/category',categoryAPIView.CategoryAPIView.as_view(),name="categoryAPIView.py"),
    path('api/category/<int:pk>',categoryAPIView.CategoryAPIView.as_view()),
